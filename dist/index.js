...
exports.GenStream = exports.ModelSocket = void 0;
const ws_1 = require("ws");
const LOG_LEVEL = process.env.MODELSOCKET_LOG || null;
const LevelLogger = {
    debug: (...args) => {
        if (LOG_LEVEL === "debug") {
...
exports.ModelSocket = ModelSocket;
class Seq {
    seqId;
    model;
    socket;
    ...
    cmds = new Map();
    constructor(seqId, model, socket, toolsEnabled, toolDefs) {
        this.seqId = seqId;
        this.model = model;
        this.socket = socket;
    ...
    onForkFinished(event) {
        ...
        let childSeq = new Seq(event.child_seq_id, this.model, this.socket, this.toolsEnabled, this.tools);
    ...
    async install(tool) {
        ...
        await this.append(`Use the function '${tool.name}' to: ${tool.description}\n` +
            JSON.stringify({
                name: tool.name,
...
var ReqType;
(function (ReqType) {
    ReqType["SEQ_OPEN"] = "seq_open";
    ReqType["SEQ_COMMAND"] = "seq_command";
})(ReqType || (ReqType = {}));
var SeqCommandType;
(function (SeqCommandType) {
    SeqCommandType["SEQ_CLOSE"] = "close";
    SeqCommandType["SEQ_APPEND"] = "append";
    SeqCommandType["SEQ_GEN"] = "gen";
    SeqCommandType["SEQ_FORK"] = "fork";
    SeqCommandType["TOOL_RETURN"] = "tool_return";
})(SeqCommandType || (SeqCommandType = {}));
var EventType;
(function (EventType) {
    EventType["SEQ_OPENED"] = "seq_opened";
    EventType["SEQ_CLOSED"] = "seq_closed";
    EventType["SEQ_TEXT"] = "seq_text";
    EventType["SEQ_APPEND_FINISHED"] = "seq_append_finish";
    EventType["SEQ_GEN_FINISHED"] = "seq_gen_finish";
    EventType["SEQ_FORK_FINISHED"] = "seq_fork_finish";
    EventType["SEQ_TOOL_CALL"] = "seq_tool_call";
